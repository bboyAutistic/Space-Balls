...
public class LaserMP : MonoBehaviour {
	...
	public void FireLaser(Vector3 targetPostion,Transform target=null)
	{
		if(target != null)
		{
			PlayerHealthMP playerShotByAI = target.gameObject.GetComponent<PlayerHealthMP> ();
	...
	public void LaserEffectsOnly(Vector3 point){
		lr.SetPosition (0, transform.position);
